REBOL [
	title:  "Rebol/Zlib module builder"
	date:    19-Nov-2025
	home:    https://github.com/Oldes/Rebol-Zlib-ng
	version: 0.0.1
	author: @Oldes
	type:    module
]
...
commands: [
	...
	;; Basic commands.
	version: ["Native Zlib-ng version"]
	...
	compress: [
		...
		/level quality [integer!]  "Compression level from 0 to 9."
	...
	;	 dict [binary!] "Pre-computed dictionary data"
	]
...
;-------------------------------------- ----------------------------------------
reb-code: ajoin [
	{REBOL [Title: "Rebol Zlib-NG Extension"}
	{ Name: zlib-ng Type: module}
	{ Version: 0.1.0}
	{ Needs: 3.20.5}
	{ Author: Oldes}
	{ Date: } now/utc
	{ License: MIT}
	{ Url: https://github.com/Oldes/Rebol-Zlib-ng}
	#"]"
]
...
foreach [name spec] commands [
	...
	append enu-commands ajoin ["^/^-CMD_ZLIB_" uppercase copy name #","]
...
#define ZLIB_EXT_INIT_CODE $init-code
...
write %zlib-rebol-extension.h reword :header self
write %zlib-commands-table.c  reword :ctable self
